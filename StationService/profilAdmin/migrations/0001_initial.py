# Generated by Django 4.2 on 2024-01-16 00:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idArticle', models.ForeignKey(db_column='idArticle', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.article')),
            ],
            options={
                'db_table': 'cuves',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exocpta', models.IntegerField()),
                ('idArticle', models.ForeignKey(db_column='idArticle', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.article')),
                ('idcli', models.ForeignKey(db_column='idcli', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.client')),
                ('idjournee', models.ForeignKey(db_column='idjournee', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.journeescomptable')),
                ('idstation', models.ForeignKey(db_column='idstation', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.stationservice')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idstation', models.ForeignKey(db_column='idstation', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.stationservice')),
                ('iduser', models.ForeignKey(db_column='iduser', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.utilisateur')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idArticle', models.ForeignKey(db_column='idArticle', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.article')),
                ('idfourn', models.ForeignKey(db_column='idfourn', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.fournisseur')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datefin', models.DateField()),
                ('monttarif', models.FloatField()),
                ('clients', models.ForeignKey(db_column='idcli', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.client')),
                ('idArticle', models.ForeignKey(db_column='idArticle', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.article')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exocpta', models.IntegerField()),
                ('idArticle', models.ForeignKey(db_column='idArticle', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.article')),
                ('idcuve', models.ForeignKey(db_column='idcuve', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.cuve')),
                ('idjournee', models.ForeignKey(db_column='idjournee', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.journeescomptable')),
                ('idstation', models.ForeignKey(db_column='idstation', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.stationservice')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='iduser',
            field=models.ForeignKey(db_column='iduser', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.utilisateur'),
        ),
        migrations.CreateModel(
            name='StatArticle',
            fields=[
                ...
                ('idArticle', models.ForeignKey(db_column='idArticle', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.article')),
                ('idfamille', models.ForeignKey(db_column='idfamille', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.famillearticle')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idctrcaisse', models.ForeignKey(db_column='idctrcaisse', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.ctrcaisse')),
                ('idnatope', models.ForeignKey(db_column='idnatope', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.natoperation')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='idstation',
            field=models.ForeignKey(db_column='idstation', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.stationservice'),
        ),
        migrations.AddField(
            model_name='famillearticle',
            name='idnatoperation',
            field=models.ForeignKey(db_column='idnatoperation', on_delete=django.db.models.deletion.CASCADE, to='profilAdmin.natoperation'),
        ),
        migrations.CreateModel(
            name='Entbllub',
            fields=[
